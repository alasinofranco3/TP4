...
Cliente::Cliente(bool nueva_alta, string nuevo_legajo, int nuevo_precio_base, char nuevo_tipo){
	legajo = new string;
	cout << "Pido memoria para el legajo en la posicion: " << legajo << endl;
	precio_base = new int;
	cout << "Pido memoria para el precio_base en la posicion: " << precio_base << endl;
	alta = nueva_alta;
	*legajo = nuevo_legajo;
...
Cliente::~Cliente(){
	cout << "Borro direciones de memoria de legajo y precio_base de direciones: " << legajo << " y " << precio_base << endl;
	delete legajo;
	delete precio_base;
}