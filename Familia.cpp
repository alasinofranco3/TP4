...
Familia::Familia(Lista<string>* nueva_familiares,bool nueva_alta,int nuevo_legajo, int nuevo_precio_base, char nuevo_tipo) : Cliente(nueva_alta,nuevo_legajo, nuevo_precio_base, nuevo_tipo){
