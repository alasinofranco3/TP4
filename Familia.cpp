...
Familia::Familia(Lista<string>* nueva_familiares,bool nueva_alta,string nuevo_legajo, int nuevo_precio_base, char nuevo_tipo) : Cliente(nueva_alta,nuevo_legajo, nuevo_precio_base, nuevo_tipo){
	...
	//cout << "Pido memoria para la lista de familia (en el constructor) en :" << familiares << endl;
...
Familia::~Familia(){
	cout << "Borro memoria para la lista de familia (en el destructor) en : " << familiares << endl;
	delete familiares;
}